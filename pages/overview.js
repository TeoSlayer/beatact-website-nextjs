...
export default function Home() {
        return (
            <>
                ...
                <section className="slice slice-lg">
                    ...
                    <div className="row row-grid">
                        ...
                        <div className="text-center">
                            ...
                            <a href="#">
                                <img alt="Image placeholder" src="../img/svg/illustrations/financial-data.svg" className="img-fluid" style={{height: 190}} />
                            </a>
                            </div>
                        ...
                        <div className="text-center">
                            <div className="px-4 py-5">
                            <a href="#">
                                <img alt="Image placeholder" src="../img/svg/illustrations/following.svg" className="img-fluid" style={{height: 190}} />
                            </a>
                            </div>
                            <div className="px-4 pb-4">
                            <h5>
                        ...
                        <div className="text-center">
                            <div className="px-4 py-5">
                            <a href="#">
                                <img alt="Image placeholder" src="../img/svg/illustrations/teaching.svg" className="img-fluid" style={{height: 190}} />
                            </a>
                            </div>
                            <div className="px-4 pb-4">
                            <h5>
                ...
                {/* Features (v21) */}
                <section className="slice slice-lg bg-cover bg-size--cover" style={{backgroundImage: 'url("../img/backgrounds/img-5.jpg")'}}>
                    <div className="container">
                    <div className="row">
