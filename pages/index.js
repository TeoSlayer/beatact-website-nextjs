            ...
            <>
                ...
                <div class="main-content">
                    ...
                    <div class="container py-6 py-lg-0 d-flex align-items-center position-relative zindex-100">
                        ...
                        <div class="row">
                            ...
                            <div class="position-relative">
                                <img alt="Image placeholder" src="../img/theme/light/iphone.png" class="img-fluid img-center"/>
                            </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="col-lg-4">
                            <div class="position-relative">
                            <img alt="Image placeholder" src="../img/theme/light/iphone.png" class="img-center img-fluid"/>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="d-flex align-items-start mb-5">
