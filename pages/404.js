        ...
        return (
            ...
            <div className="bg-absolute-cover vh-100 overflow-hidden">
              <figure className="w-100">
                <img alt="Image placeholder" src="../img/svg/backgrounds/bg-4.svg" className="svg-inject" />
              </figure>
            </div>
            ...
            <div className="position-absolute bottom-0 right-4 overflow-hidden">
              <figure className="w-50">
                <img alt="Image placeholder" src="../img/svg/illustrations/design-thinking.svg" className="svg-inject opacity-2" />
              </figure>
            </div>
            </section>
            </>
