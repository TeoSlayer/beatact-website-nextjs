...
export default function Home({ posts }) {
        return (
            ...
            {/* Cover (v3) */}
            <section className="spotlight bg-cover bg-size--cover" data-spotlight="fullscreen" style={{backgroundImage: 'url("../../../static/assets/template/assets/img/backgrounds/img-1-1920x800.jpg")'}}>
