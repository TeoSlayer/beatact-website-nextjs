                ...
                <div class="main-content">
                        ...
                        <div class="container py-6 py-lg-0 d-flex align-items-center position-relative zindex-100">
                            ...
                            <div class="row">
                                ...
                                <div class="text-center text-lg-left pb-5">
                                    <h2 class="h1 text-white mb-4">One party can change your <span class="text-info typed" id="type-example-1" data-type-this="mood., energy., day."></span></h2>
                                    <p class="lead lh-180 text-white">The first centralized app for techno events and parties in Romania</p>
                                    <div class="mt-5">
                                ...
                                <div class="swiper-container" data-swiper-items="1" data-swiper-space-between="0" data-swiper-sm-items="2" data-swiper-xl-items="3">
                                    ...
                                    <div class="swiper-slide p-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <img alt="Image placeholder" src="../static/assets/template/assets/img/theme/light/team-1-800x800.jpg" class="avatar  rounded-circle"/>
                                            </div>
                                            <div class="pl-3">
                                    ...
                                    <div class="swiper-slide p-4">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                            <div>
                                                <img alt="Image placeholder" src="../static/assets/template/assets/img/theme/light/team-2-800x800.jpg" class="avatar  rounded-circle"/>
                                            </div>
                                            <div class="pl-3">
                                    ...
                                    <div class="swiper-slide p-4">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                            <div>
                                                <img alt="Image placeholder" src="../static/assets/template/assets/img/theme/light/team-3-800x800.jpg" class="avatar  rounded-circle"/>
                                            </div>
                                            <div class="pl-3">
                                    ...
                                    <div class="swiper-slide p-4">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                            <div>
                                                <img alt="Image placeholder" src="../static/assets/template/assets/img/theme/light/team-4-800x800.jpg" class="avatar  rounded-circle"/>
                                            </div>
                                            <div class="pl-3">
                                    ...
                                    <div class="swiper-slide p-4">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                            <div>
                                                <img alt="Image placeholder" src="../static/assets/template/assets/img/theme/light/team-5-800x800.jpg" class="avatar  rounded-circle"/>
                                            </div>
                                            <div class="pl-3">
                    ...
                    <section class="slice slice-xl overflow-hidden bg-gradient-dark delimiter-top delimiter-bottom">
                        <div class="bg-absolute-cover bg-size--contain d-flex align-items-center">
                            <figure class="w-100">
                            <img alt="Image placeholder" src="../static/assets/template/assets/img/svg/backgrounds/bg-3.svg" class="svg-inject"/>
                            </figure>
                        </div>
