...
export default function Home({ eventsThisMonth, eventsNextMonth }) {
        ...
        <>
            ...
            <div className="main-content">
                ...
                <section className="slice slice-xl bg-cover bg-size--cover" data-offset-top="#header-main" style={{backgroundImage: 'url(../../img/backgrounds/img-5.jpg)', width: '100%',backgroundSize: 'cover'}}>
